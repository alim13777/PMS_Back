...
class paperController extends Controller
{
    ...
    public function findPartyPaper($partyId,$currentUser,$history){
    ...
    foreach ($papers as $paper) {
        $res=$this->find($paper->paperId,$currentUser,$history)->original;
        array_push($response,$res[0]);
    }
    return response()->json($response);
    }
    public function find($paperId,$currentUser,$history){
